...
define('_JSHOP_paybox_MERCHANT_ID_DESCRIPTION','Get it on https://paybox.kz/admin/merchants.php');
define('_JSHOP_paybox_SECRET_KEY','Secret word');
define('_JSHOP_paybox_SECRET_KEY_DESCRIPTION','Get it on https://paybox.kz/admin/merchants.php');
